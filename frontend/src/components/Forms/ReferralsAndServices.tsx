...
type IReferralsAndServicesInputs = z.infer<
  typeof ReferralsAndServicesInputsSchema
>;

const ReferralsAndServicesResponseSchema =
  ReferralsAndServicesInputsSchema.extend({
    id: z.string(),
    user_id: z.string(),
  });
  ...
  const { mutate } = useMutation(
    ...
    },
    {
      onSuccess: (data) => {
        ...
        console.log(
          `ReferralsAndServices data ${method} successfully.`,
          userData
        );
