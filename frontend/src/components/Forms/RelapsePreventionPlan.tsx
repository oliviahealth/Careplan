...
type IRelapsePreventionPlanInput = z.infer<
  typeof RelapsePreventionPlanInputSchema
>;

const RelapsePreventionPlanResponseSchema =
  RelapsePreventionPlanInputSchema.extend({
    id: z.string(),
    user_id: z.string(),
  });
