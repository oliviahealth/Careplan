      ...
      <BrowserRouter basename="/">
        <Routes>
          <Route element={<Layout />}>
            ...
            <Route
              path="/maternal-demographics/:submissionId?"
              element={
                <BackPage>
            ...
            />
            <Route
              path="/maternal-medical-history/:submissionId?"
              element={
                <BackPage>
            ...
            />
            <Route
              path="/psychiatric-history/:submissionId?"
              element={
                <BackPage>
                  <PsychiatricHistory />
                </BackPage>
            ...
            />
            <Route
              path="/medical-services-for-substance-use/:submissionId?"
              element={
                <BackPage>
            ...
            />
            <Route
              path="/substance-use-history/:submissionId?"
              element={
                <BackPage>
                  <SubstanceUseHistory />
                </BackPage>
            ...
            />
            <Route
              path="/drug-screening-results/:submissionId?"
              element={
                <BackPage>
            ...
            />
            <Route
              path="/family-and-supports/:submissionId?"
              element={
                <BackPage>
                  <FamilyAndSupports />
                </BackPage>
            ...
            />
            <Route
              path="/infant-information/:submissionId?"
              element={
                <BackPage>
                  <InfantInformation />
                </BackPage>
            ...
            />
            <Route
              path="/referrals-and-services/:submissionId?"
              element={
                <BackPage>
            ...
            />
            <Route
              path="/relapse-prevention-plan/:submissionId?"
              element={
                <BackPage>
